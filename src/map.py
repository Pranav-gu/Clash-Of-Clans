...
def printMap(V):
    ...
    for arch in stealth_archers:
        ...
        map_matrix[a+1][b+1] = archColor(arch) + Fore.BLACK + ''
    #----------------------------code added down---------------------------------------
    ...
    for he in healers:
        a= 2*he.position[0]
        b = 2*he.position[1]
        map_matrix[a][b] = blColor(he) + Fore.BLACK + 'HE'
        map_matrix[a+1][b] = blColor(he) + Fore.BLACK + ' E'
        map_matrix[a][b+1] = blColor(he) + Fore.BLACK + 'AL'
        map_matrix[a+1][b+1] = blColor(he) + Fore.BLACK + 'R '
    #----------------------------code added down---------------------------------------
